        ...
        try {
            ...
            (function () {
                ...
                function closeSwipeActions(exceptKey = '') {
                    ...
                    getSwipeLists().forEach((list) => {
                        list.querySelectorAll('.capture-swipe-item').forEach((item) => {
                            ...
                            const shouldOpen = safeKey && itemKey === safeKey;
                ...
                function buildSwipeItemMarkup(item, listType = 'active') {
                    ...
                    return `
                        <li class="capture-swipe-item" data-id="${itemId}" data-list-type="${listType}" data-swipe-key="${escapeHtml(swipeKey)}" style="--swipe-offset: 0px;">
